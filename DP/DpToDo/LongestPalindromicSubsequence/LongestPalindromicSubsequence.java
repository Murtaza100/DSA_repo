 ...
 * - We need to find the length of its Longest Palindromic 
 * Subsequence (LPS) in the given String using Dynamic 
 * Programming.

A subsequence is a sequence that can be derived from another 
string by deleting some or no elements without changing the 
order of the remaining elements.

Palindrome is a string that reads the same backward as well as 
forward.
...
public class LongestPalindromicSubsequence {
    public static void main(String[] args) {
        System.out.println("using top-down : ");
        System.out.println(findLPSLength("ELRMENMET"));
        System.out.println("using bottom-up : ");
        System.out.println(findLPSLengthBU("ELRMENMET"));
    }
