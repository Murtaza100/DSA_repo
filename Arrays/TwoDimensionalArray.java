...
public class TwoDimensionalArray {
  ...
  public static void main(String[] args) {
    TwoDimensionalArray twoDArray = new TwoDimensionalArray(2, 2);
    twoDArray.insertValueInTheArray(0, 0, 1);
    twoDArray.insertValueInTheArray(0, 1, 2);
    twoDArray.insertValueInTheArray(1, 0, 3);
    twoDArray.insertValueInTheArray(1, 1, 1);
